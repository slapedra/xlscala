...
// Returns:
//
//      LPXLOPER        The temporary XLOPER12, or 0
...
LPXLOPER TempNum(double d)
{
	...
	lpx = (LPXLOPER) GetTempMemory(sizeof(XLOPER12));
...
//
// Purpose:
//      Creates a temporary string XLOPER12
//
// Parameters:
//
...
//      temp XLOPER12 of the form "\003abc"
//
//
///***************************************************************************
...
LPXLOPER TempStrConst(const LPSTR lpstr)
{
	...
	lpx = (LPXLOPER) GetTempMemory(sizeof(XLOPER12) + len+1);
...
LPXLOPER TempActiveRef(WORD rwFirst, WORD rwLast, BYTE colFirst, BYTE colLast)
{
	...
	/* calling Excel() instead of Excel12() would free all temp memory! */
...
// Parameters:
//
//      LPXLOPER pxloper    Pointer to the XLOPER12 whose associated
...
//      LPXLOPER pxloper        Pointer to the XLOPER12 to copy into
//
// Returns:
//
//      BOOL                    TRUE if the conversion succeeded, FALSE otherwise
...
BOOL XLOper12ToXLOper(LPXLOPER12 pxloper12, LPXLOPER pxloper)
{
	...
	case xltypeMulti:
		...
		else
		{
			...
			{
				rgxloperConv = (xloper*)malloc(cxloper12 * sizeof(XLOPER12));
	...
	case xltypeBigData:
		...
		if (pxloper12->val.bigdata.h.lpbData != NULL && cbyte > 0)
		{
			...
			if (pbyte != NULL)
			{
				...
				memcpy(pbyte, pxloper12->val.bigdata.h.lpbData, cbyte);
...
//
// Purpose:
//      Conversion routine used to convert from the old XLOPER12
//      to the new XLOPER12.
//
// Parameters:
//
//      LPXLOPER pxloper        Pointer to the XLOPER12 to copy
...
BOOL XLOperToXLOper12(LPXLOPER pxloper, LPXLOPER12 pxloper12)
{
	...
	case xltypeMulti:
		...
		else
		{
			...
			{
				rgxloper12Conv = (xloper12*)malloc(cxloper * sizeof(XLOPER12));
	...
	case xltypeBigData:
		...
		if (pxloper->val.bigdata.h.lpbData != NULL && cbyte > 0)
		{
			...
			if (pbyte != NULL)
			{
				...
				memcpy(pbyte, pxloper->val.bigdata.h.lpbData, cbyte);
